...
export const data = new SlashCommandBuilder()
  .setName('leave-background')
  .setDescription('Set the background image for the leave card')
  .addSubcommand((sub) =>
    sub
      .setName('default')
...
export async function execute(interaction, res) {
  ...
  if (sub === 'default') {
    ...
    const embed = new EmbedBuilder()
      .setColor(0xed4245)
      .setTitle('Leave Background Updated')
  ...
  if (sub === 'upload') {
    ...
    await uploadBinary('guilds/' + guildId + '/assets/leave_bg.png', buffer, 'image/png')
    ...
    const embed = new EmbedBuilder()
      .setColor(0xed4245)
      .setTitle('Leave Background Uploaded')
      .setDescription('Your custom leave background is now active.')
